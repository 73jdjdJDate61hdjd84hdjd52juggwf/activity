...
$(function(){
	$('#grid').datagrid({
		...
		columns : [ [ 
                ...
                {title : '权限名',  field : 'name', width : 80,sortable : true },
                {title : '权限描述',  field : 'desc', width : 80,sortable : true },
                {title : '模块ID',  field : 'modelCode', width : 80,sortable : true },
                {title : 'URL',  field : 'requestUrl', width : 160,sortable : true },
