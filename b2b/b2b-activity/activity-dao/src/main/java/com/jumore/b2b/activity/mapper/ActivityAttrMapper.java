/**
 * 活动属性
 * ActivityAttrMapper.java
 * Copyright(C) 2015-2015 xxxxxx公司
 * All rights reserved.
 * -----------------------------------------------
 * 2016-07-01 Created
 */
package com.jumore.b2b.activity.mapper;
...
public interface ActivityAttrMapper extends BaseMapper<ActivityAttr, ActivityAttrQueryHelper> {
}